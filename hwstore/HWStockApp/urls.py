...
urlpatterns = [
    ...
    path('ActualizarProductos/<int:pk>', ActualizarProductos.as_view(), name="ActualizarProductos"),
    path('BorrarProductos/<int:pk>', BorrarProductos.as_view(), name="BorrarProductos"),
